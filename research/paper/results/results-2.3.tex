...
\JL{KASUN: remember to also include the value of the mass-damping as well as $U^*$ in the following paragraphs. I have set things up so that \massdamp\ is the same as your original parameter}
