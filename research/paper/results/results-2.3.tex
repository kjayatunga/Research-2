...
\begin{equation}
  \label{eqn:eigs}
  \lambda_{1,2}= -\frac{1}{2}\frac{c-\frac{1}{2}\rho U^2\mathcal{A}a_1}{(m+m_a)U}\pm\frac{1}{2}\sqrt{\left[\frac{c-\frac{1}{2}\rho U^2\mathcal{A}a_1}{(m+m_a)U}\right]^2-4\frac{k}{(m+m_a)}}.
\end{equation}
...
\begin{equation}
  ...
  \lambda=-\frac{c-\frac{1}{2}\rho U^2\mathcal{A}a_1}{(m+m_a)U}.
\end{equation}
...
\begin{equation}
  ...
  \lambda=\frac{\frac{1}{2}\rho U^2\mathcal{A}a_1}{(m+m_a)U}.
\end{equation}
