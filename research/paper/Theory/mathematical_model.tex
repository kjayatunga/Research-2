...
\end{equation}
\JL{KASUN: why do you have an added mass term here? This implies that you have decomposed the lift force into components. I think you should remove it here and from the rest of the document.}
